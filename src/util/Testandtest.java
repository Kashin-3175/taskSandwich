...
public class Testandtest {
    public static void main(String[] args) throws SQLException {
        String jdbcUrl = "jdbc:h2:~/testdb;jdbc:h2:~/test;AUTO_SERVER=TRUE;CACHE_SIZE=8192;AUTO_RECONNECT=TRUE;DB_CLOSE_ON_EXIT=FALSE;INIT=RUNSCRIPT FROM 'classpath:init.sql'\\\\;SET CHARACTER_SET utf8\n";
        String username = "sa";
        String password = "";
